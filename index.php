...
$works=[
    ...
    "discription"=> "описание работы рараотчиком.",
    ],
    [
    "name"=> "слесарь",
    "datestart"=> "2010 май",
    "dateend"=> "2020 май",
    "discription"=> "тут описание работы слесарем.",
    ],
    [
    "name"=> "фрезеровщик",
    "datestart"=> "2008 октябрь",
    "dateend"=> "2010  май",
    "discription"=> "описание работы фрезеровщиком."
    ]   
            ...
            <div class="w3-twothird">
                <div class="w3-container w3-card w3-white w3-margin-bottom">
                    ...
                    <div class="w3-container">
                        ...
                        </i><?php echo $works[$i]['datestart'];?> - <?php echo $works[$i]['dateend'];?></h6>
